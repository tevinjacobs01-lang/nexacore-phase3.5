  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      ...
      >
        ...
        {resetToken && (
          <div className="mb-4 rounded-md bg-green-50 dark:bg-green-950/30 px-3 py-2 text-sm text-green-700 dark:text-green-400">
            <p>Password reset token generated for development use.</p>
            <p className="mt-2 break-all font-mono text-xs">{resetToken}</p>
            <Link
              to={`/reset-password?token=${encodeURIComponent(resetToken)}`}
              className="mt-3 inline-block font-medium text-brand-600 hover:text-brand-700 dark:text-brand-500"
            >
